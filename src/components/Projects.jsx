...
export default function Projects() {
  return (
    <section id="project" className="py-24 px-28 bg-surface">
      ...
      <div className="max-w-4xl">
        <h2 className="font-family-serif text-7xl leading-tight font-medium text-text-primary">
          Dua project, <br />
          satu standar kode.
        </h2>
      ...
      <div className="relative grid grid-cols-12 gap-8 py-14 border-b border-text-muted/20 group cursor-pointer overflow-hidden">
        ...
        <div className="col-span-1 relative z-10">
          <span className="font-family-serif text-6xl italic text-text-muted/40 transition-transform duration-500 ease-out group-hover:translate-x-3">
            01
          </span>
        </div>

        <div className="col-span-8 relative z-10 transition-transform duration-500 ease-out group-hover:translate-x-5">
          ...
          <p className="mt-4 text-lg text-text-muted leading-relaxed max-w-3xl">
        ...
        <div className="col-span-3 relative z-10 flex flex-col items-end justify-between">
          <span className="px-5 py-2 rounded-full border border-green-500/30 bg-green-500/10 text-green-600 text-xs uppercase tracking-[0.25em] font-family-mono">
            ✓ Completed
          </span>

          <div className="flex gap-6 mt-20 text-xs uppercase tracking-[0.25em] font-family-mono">
            <a
