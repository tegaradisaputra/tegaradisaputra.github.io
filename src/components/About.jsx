          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            <div className="flex flex-col">
              ...
              <div className="mt-8 md:mt-10 border border-accent rounded-md p-4 max-w-2xl bg-accent-soft ">
                <p className='text-text text-sm md:text-base'><span className='text-accent font-medium'>Jujur soal skill level:</span> Saya junior yang baru memulai karir, tapi saya memahami <span className='italic'>mengapa</span> sebuah pattern digunakan,  bukan hanya cara menggunakannya. Saya cepat belajar dan sangat eager untuk berkembang.
                </p>
              </div>
            </div>
