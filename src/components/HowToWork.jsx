...
export default function HowToWork() {
  return (
    <>
      <section id='how-i-work' className='py-24 px-28 flex justify-between items-center bg-background'>
        <div className='w-full'>
          ...
          <div className="flex justify-between items-center">
            <h3 className='font-family-serif font-medium w-xl text-6xl'>Cara saya bekerja, bukan hanya apa yang saya <span className='text-accent'>bisa.</span></h3>

            <p className='font-family-sans w-xl text-text mt-30'>Skill bisa dipelajari — tapi kebiasaan kerja yang baik itu yang membuat developer berdampak di tim. Ini adalah proses dan nilai yang saya bawa ke setiap pekerjaan.</p>
          </div>


          <div className="grid grid-cols-4">

            <div className="card mt-24 border-2 grid justify-start items-center border-background-secondary bg-surface w-full p-8 rounded-lg hover:bg-accent-soft/90">
              <span className='text-background-secondary font-family-serif text-6xl italic font-medium'>01</span>
              ...
              <p className='mt-4 bg-accent-soft px-4 py-2 border-2 flex justify-center items-center  border-accent/20 text-accent font-medium rounded-full'>Baca · Tanya · Konfirmasi</p>
            </div>

            <div className="card mt-24 border-2 grid justify-start items-center border-background-secondary bg-surface w-full p-8 rounded-lg hover:bg-accent-soft/90">
              <span className='text-background-secondary font-family-serif text-6xl italic font-medium'>02</span>
              ...
              <p className='mt-4 bg-accent-soft px-4 py-2 border-2 flex justify-center items-center  border-accent/20 text-accent font-medium rounded-full'>ERD · API Contract · Folder</p>
            </div>

            <div className="card mt-24 border-2 grid justify-start items-center border-background-secondary bg-surface w-full  p-8 rounded-lg hover:bg-accent-soft/90">
              <span className='text-background-secondary font-family-serif text-6xl italic font-medium'>03</span>
              ...
              <p className='mt-4 bg-accent-soft px-4 py-2 border-2 flex justify-center items-center  border-accent/20 text-accent font-medium rounded-full'>Pattern · Clean Code · Git</p>
            </div>

            <div className="card mt-24 border-2 grid justify-start items-center border-background-secondary bg-surface w-full p-8 rounded-lg hover:bg-accent-soft/90">
              <span className='text-background-secondary font-family-serif text-6xl italic font-medium'>04</span>
              ...
              <p className='mt-4 bg-accent-soft px-4 py-2 border-2 flex justify-center items-center  border-accent/20 text-accent font-medium rounded-full'>Postman · Feedback · Iterate</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-3 gap-6 items-stretch">
              ...
              <div className="relative group mt-24 border-2 grid justify-start items-center border-background-secondary bg-surface w-full px-8 py-10 rounded-lg hover:-translate-y-2 transition-transform duration-300">
